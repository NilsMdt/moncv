...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/loisirs'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/experiences'), array(0 => 'ROLE_ADMIN'), NULL);
