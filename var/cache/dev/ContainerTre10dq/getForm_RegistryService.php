...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ExperienceType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ExperienceType']) ? $this->services['AppBundle\Form\ExperienceType'] : $this->services['AppBundle\Form\ExperienceType'] = new \AppBundle\Form\ExperienceType()) && false ?: '_'};
}, 'AppBundle\\Form\\FormationType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FormationType']) ? $this->services['AppBundle\Form\FormationType'] : $this->services['AppBundle\Form\FormationType'] = new \AppBundle\Form\FormationType()) && false ?: '_'};
}, 'AppBundle\\Form\\LoisirType' => function () {
